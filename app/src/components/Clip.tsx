...
import { Colors, ContextMenuTarget, Menu, MenuItem, TextArea } from '@blueprintjs/core';
...
@ContextMenuTarget
class _ClipComponent extends React.Component<
    { dispatch: ThunkDispatch<{}, {}, AnyAction> } & { clip: Clip },
    { edit: boolean; value: string }
> {
  constructor(props) {
      super(props);
      this.state = {
      ...
      return (
            ...
            >
                ...
                {edit ? (
                    ...
                    <div className="no-select" style={style.content}>
                        {content}
                    </div>
                )}
